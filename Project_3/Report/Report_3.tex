...
\begin{itemize}
  ...
  \item Making sure the heuristic does not overestimate. If it does, then the algorithm is no longer admissable as a heuristic, ergo the optimal path is no longer guaranteed. In an effort to ensure never overestimating, the heuristic is modified by 
\end{itemize}
